...
const buildDescriptionHtml = (post) => {
  ...
  description += `<b><a href="/blog/${post.slug}">Read more...</a></b><br/><br/>`;
  if (post.hero) {
...
const defaultChannel = {
  ...
  link: '/',
  title: 'Piyush Yadav',
  description: 'Passionate and creative full-stack developer from India',
  ...
  copyright: `All rights reserved ${new Date().getFullYear()}, Piyush Yadav`,
};
